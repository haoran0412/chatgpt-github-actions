    ...
    for diff_text in parsed_text:
        ...
        try:
            ...
            response = openai.Completion.create(
                ...
                prompt=(f"I want you to act as a code reviewer of this Pull Request. I will provide you the code changes made of this Pull Request. You will help me identify potential bugs in this code, give important suggestions on improving the code quality and maintainability, and check if it adheres to coding standards and best practices.The following diff is the changes made in this Pull Request:\n```{diff_text}```"),
                temperature=float(args.openai_temperature),
                max_tokens=int(args.openai_max_tokens)
            )
            print(response)
